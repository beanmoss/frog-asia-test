        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td>
                    ...
                    @if(!$frog->is_dead)
                    <a onclick="return confirm('Really? Mosquitos coming right up!')" href="{{route('frog.kill',['id' => $frog->id])}}" class="btn btn-danger">Kill</a>
                    <a href="{{route('frog.mate',['id' => $frog->id])}}" class="btn btn-success">Mate with...</a>
                    @endif
                </td>
            </tr>
            @empty
